...
<html>
	...
	<body>
		<a href="#edit-camRegistration" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-camRegistration" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${camRegistrationInstance?.version}" />
				<fieldset class="form">
